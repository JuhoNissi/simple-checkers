...
else
{
	...
	if(pieceCol == 5)
	{
		if(isPlayer ) System.out.println("there are no right spots for"+board[pieceRow][pieceCol].getOccupier()+", you are at edge");
		can = false; 
	}
	else
	{
		...
		{
			if(isPlayer && !board[pieceRow][pieceCol].getOccupier().equals("X")) System.out.println("the right spot of "+board[pieceRow][pieceCol].getOccupier()+", is occupied");
			can = false;
		}
...
else
{
	...
	if(pieceCol == 0)
	{
		if(isPlayer && !board[pieceRow][pieceCol].getOccupier().equals("X")) System.out.println("there are no Left spots for "+board[pieceRow][pieceCol].getOccupier()+", you are at edge");
		can = false;
	}
	else
	{
		...
		{
			if(isPlayer && !board[pieceRow][pieceCol].getOccupier().equals("X"))System.out.println("the left spot of "+board[pieceRow][pieceCol].getOccupier()+"  is occupied");
			can = false;
		}
